package com.tasktracker.app.view.user;
...
public class UsersView
{
    ...
    public UsersView(int width, int height)
    {
        this.width = width;
        this.height = height;
    ...
    private void initUserListPanel()
    {
        ...
        userList.addMouseListener(new MouseAdapter()
        {
            public void mouseClicked(MouseEvent me)
            {
                ...
                curUser = ModelContainer.getInstance().getUser(selectedName);
        ...
        deleteButton.addActionListener(new AbstractAction()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                try
                {
                    TaskController.deleteUser(userName);
                }
                catch (TaskTrackerLogicException e1)
                {
        ...
        commitButton.addActionListener(new AbstractAction()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (nameCtrl.getBackground().equals(Color.GREEN))
                {
                    ...
                    try
                    {
                        TaskController.changeUserName(curUser.getName(), newValue);
                    }
                    catch (TaskTrackerLogicException e1)
                    {
                        showErrorDialog(e1.getMessage());
